        ...
        <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
          <div class="relative w-full">
            ...
            <input
              ...
              id="search" name="search" type="search" placeholder="Search for article" autocomplete="off">
          </div>
          <div>
            <button
    ...
    <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      @forelse ($posts as $post)
        <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
          ...
          <div class="flex justify-between items-center">
            ...
            <a class="inline-flex items-center font-medium text-sm text-primary-600 dark:text-primary-500 hover:underline"
      ...
      @empty
        <div class="">
          ...
          <a href="/posts" class="block text-blue-600 hover:under">&laquo; Back to all posts</a>
        </div>
      @endforelse
    </div>
  </div>
